...
namespace AlphaABSV2.Controllers
{
    public class EmailCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryName")] EmailCategories emailCategories)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryName")] EmailCategories emailCategories)
        {
            if (ModelState.IsValid)
            {
